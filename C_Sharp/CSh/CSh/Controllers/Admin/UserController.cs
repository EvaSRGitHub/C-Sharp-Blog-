...
namespace CSh.Controllers.Admin
{
    ...
    public class UserController : Controller
    {
        ...
        public ActionResult List()
        {
            using (var database = new BlogDbContext())
            {
                ...
                var admins = GetAdminUserName(users, database);
        ...
        private HashSet<string> GetAdminUserName(List<ApplicationUser> users, BlogDbContext context)
        {
        ...
        private List<Role> GetUserRoles(ApplicationUser user, BlogDbContext database)
        {
            ...
            //For each japplication role, check if the user has it
