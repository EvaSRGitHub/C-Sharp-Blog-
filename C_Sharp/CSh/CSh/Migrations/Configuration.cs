namespace CSh.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<CSh.Models.BlogDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            ContextKey = "CSh.Models.BlogDbContext";
            AutomaticMigrationDataLossAllowed = true;
        }

        protected override void Seed(CSh.Models.BlogDbContext context)
        {
            ...
            {
                this.CreateUser(context, "admin@admin.com", "Admin", "admin1");
